...
fun main() {
    val a = SS58Encoder.decode("j4U6AD4go9Q7FzyWKRkh9pxj4hieB5SyYh8Ha4B5F57vSmgGJ")
    println(a)
    val b = SS58Encoder.encode(
        SS58Type.Network.from(126),
        "0x7a7240a41b11b25db5b00105b2b033f0bac829c506c7b20c80c792537075c131".hexToBytes()
    )
    println(b)
}
